...
public class ReaderMapper extends Mapper<Object, Text, Text, Text> {
	 ...
	 * itself and a default page rank of 1.0 is assigned to every page node the mapper encounters.
	 * The mapper also updates the number of pages it sees in the counter COUNT for use in the next job,
	...
	public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		try {
			...
			// create StringBuilder for adjacency list and store initial page rank value of 1.0
